...
2. What we do every day: not a service list (we have separate pages for that) but the *texture* of the work — being on call (per the brand's Hours — do not claim 24/7 unless Hours say so), documenting losses thoroughly, responding to homeowners in the worst moments of their year.
