...
4. **SERVICE-SPECIFIC FAQs**. Every FAQ on this page must be ABOUT THIS SERVICE. Do not write generic restoration FAQs that would fit on any service page.
   ...
   - "Do you bill insurance?" (NEVER for this brand — insurance relationships unverified)
...
All FAQs must be SPECIFIC TO {service.display_name}. See the GOOD/BAD examples above. Mix technical depth (process, equipment, timeline) with practical concerns (documentation for the homeowner's own records, what to do while waiting) — but EVERY question must clearly belong on a {service.display_name} page, not just any service page.
